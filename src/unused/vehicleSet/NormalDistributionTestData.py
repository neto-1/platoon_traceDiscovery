...
class NormalDistribution(object):
    ...
    def DefineDistributionRanges(self,numOfVehicles):
        ...
        mainRange = np.random.normal(mu, sigma, numOfVehicles)
    ...
    def create_vehicle(self,numOfVehicles):
        ...
        while count != numOfVehicles:
            ...
            if found:
                ...
                count=count+1
        DBOperations.RunQueries(self.db,startNodesId,endNodesId,distances,paths_nodes,numOfVehicles,"normal")
# dbuser = "neo4j"
# dbpass = "12345678"
# db = GraphDatabase("http://localhost:7474", username=dbuser, password=dbpass)
# # #
# x=NormalDistribution(db,100.5,0.8) # (database connection, the length of longest path, the scale value [0,1])
