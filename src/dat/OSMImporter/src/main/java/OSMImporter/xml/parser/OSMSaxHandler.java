package OSMImporter.xml.parser;

import org.xml.sax.Attributes;
import org.xml.sax.SAXException;
import org.xml.sax.helpers.DefaultHandler;

import OSMImporter.xml.Factory;
import OSMImporter.xml.OSMHandler;
import OSMImporter.xml.model.OSMElement;
...
public class OSMSaxHandler extends DefaultHandler {
	...
	private void _startMember(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		((OSMRelation)element).member_ref.add(saxHelper.asLong(attributes, "ref"));
