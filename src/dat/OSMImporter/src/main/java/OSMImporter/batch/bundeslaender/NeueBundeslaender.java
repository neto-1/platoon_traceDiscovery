...
public class NeueBundeslaender {
	...
	public static void main(String[] args) {
		...
		importer.importFromFile("E:\\data\\bundeslaender\\brandenburg-latest.osm",
				"E:\\data\\bundeslaender\\mecklenburg-vorpommern-latest.osm",
				"E:\\data\\bundeslaender\\sachsen-anhalt-latest.osm",
				"E:\\data\\bundeslaender\\sachsen-latest.osm",
				"E:\\data\\bundeslaender\\thueringen-latest.osm");
	}
